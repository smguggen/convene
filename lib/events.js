class Events {
    constructor(parent) {
        this.valid = ['reading', 'writing', 'drained', 'next', 'source', 'success', 'fail', 'error', 'queueError', 'end', 'readEnd', 'writeEnd', 'objectWriteEnd'];
        this.calcs = {}
        this.counts = {};
    ...
    calc(event, ...args) {
        this.counts[event]++;
        console.log('Fired: ' + event, this.counts[event]);
        let res = null;
